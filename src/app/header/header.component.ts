...
export class HeaderComponent implements OnInit {
  ...
  constructor(config: NgbDropdownConfig, private cartService: CartService,public _HomeService: HomeService, public _Router: Router,private activetedRoute: ActivatedRoute) {
