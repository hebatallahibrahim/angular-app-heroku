...
export class ProductItemComponent implements OnInit {
  ...
  addOrRemoveWishlist(){
    ...
    this.wishlistService.addToWishlist(formData,this.productItem.id).subscribe(
      (data) => {
        console.log(data);
      ...
      this.wishlistService.deleteFromWishlist(queryParams,this.productItem.id).subscribe(
        (res) => {
        console.log(res);
